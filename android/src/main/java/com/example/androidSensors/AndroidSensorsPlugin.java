...
/** AndroidSensorsPlugin */
public class AndroidSensorsPlugin implements FlutterPlugin, MethodCallHandler,SensorEventListener,EventChannel.StreamHandler {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    ...
    channel = new MethodChannel(flutterPluginBinding.getFlutterEngine().getDartExecutor(), "androidSensors");
  ...
  private void onAttachedToEngine(Context applicationContext, BinaryMessenger messenger) {
    ...
    channel = new MethodChannel(messenger, "androidSensors");
    channel.setMethodCallHandler(this);
  }
  public static void registerWith(Registrar registrar) {
    AndroidSensorsPlugin plugin = new AndroidSensorsPlugin();
    final MethodChannel channel = new MethodChannel(registrar.messenger(), "androidSensors");
    channel.setMethodCallHandler(new AndroidSensorsPlugin());
  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
   ...
   sensorManager.registerListener(AndroidSensorsPlugin.this,rotationVector,SensorManager.SENSOR_DELAY_NORMAL);
