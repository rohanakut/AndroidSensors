## all_mobile_sensors
A flutter plugin that enables easy access to all android sensors. The user just has to run a simple function to get the senor values. This package enables the user to omit the native platform specific code and get the sensor value easily for their application.
